...
out = cv2.VideoWriter("./Videos/" + videoNameString + ".mp4", codec, FPS, SCREEN_SIZE)
# X and Y coordinates of mouse pointer
Xs = [0,8,6,14,12,4,2,0]
Ys = [0,2,4,12,14,6,8,0]
...
@bp.route('videoNameString')
def serve(videoNameString):
    video_path = os.path.join(VIDEOS_FOLDER, videoNameString)
